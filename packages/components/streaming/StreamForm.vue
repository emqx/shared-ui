  ...
  <el-form ref="form" :model="record" label-position="top">
    <el-form-item prop="stream_name">
      <template #label>
        ...
        <component :is="tipComponent" :content="t('streaming.streamNameTip')" />
      </template>
    ...
    <el-form-item prop="stream_type">
      <template #label>
        ...
        <component :is="tipComponent" :content="t('streaming.streamTypeTip')" />
      </template>
    ...
    <el-form-item v-if="record.stream_type === StreamType.Default" prop="mqtt_topic_filter">
      <template #label>
        ...
        <component :is="tipComponent" :content="t('streaming.mqttTopicTip')" />
      </template>
