export const enConnectorsLabel: Record<string, Record<string, string>> = {
  ...
  zerobus: {
    zerobus_endpoint: 'Zerobus Endpoint',
    authentication: 'Authentication',
    authentication_enable: 'Enable Authentication',
    workspace_id: 'Workspace ID',
    workspace_url: 'Workspace URL',
    client_id: 'Client ID',
    client_secret: 'Client Secret',
    authentication_timeout: 'Authentication Timeout',
    authentication_ssl: 'Authentication TLS',
    transport: 'Transport Type',
    transport_type: 'Transport Type',
    transport_connect_timeout: 'Connect Timeout',
    transport_pool_size: 'Connection Pool Size',
    transport_pipelining: 'HTTP Pipelining',
    transport_max_inactive: 'Maximum Inactivity',
    ssl: 'Zerobus TLS',
  },
}
