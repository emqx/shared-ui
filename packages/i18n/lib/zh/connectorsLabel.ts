export const zhConnectorsLabel: Record<string, Record<string, string>> = {
  ...
  zerobus: {
    zerobus_endpoint: 'Zerobus 服务地址',
    authentication: '认证',
    authentication_enable: '启用认证',
    workspace_id: '工作区 ID',
    workspace_url: '工作区 URL',
    client_id: '客户端 ID',
    client_secret: '客户端密钥',
    authentication_timeout: 'Token 请求超时',
    authentication_ssl: '认证 TLS',
    transport: '传输协议',
    transport_type: '传输协议',
    transport_connect_timeout: '连接超时',
    transport_pool_size: '连接池大小',
    transport_pipelining: 'HTTP 流水线',
    transport_max_inactive: '最大空闲时间',
    ssl: 'Zerobus TLS',
  },
}
